...
module.exports = function (target, metadata) {
    target = path.join(TEMP_NAME, target || '')
    return new Promise((resolve, reject) => {
        let url = 'direct:https://github.com/chenglin0006/cl-cli-template.git' // 远程仓库模板项目地址
        if(metadata.ifh5==='yes'){
            url = 'direct:https://github.com/chenglin0006/cl-cli-template-h5.git' // 远程仓库模板项目地址
        }
